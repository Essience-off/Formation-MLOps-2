...
def predict_endpoint():
    ...
    received_data_df["Ws1_avg"] = Ws1_avg
    received_wind_speed_avg = prepare_features(received_data_df, training_mode=False)
    pred = predict(received_wind_speed_avg, config.MODEL_PATH)
    print(pred)
